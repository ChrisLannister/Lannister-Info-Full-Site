...
_gaq.push(['_trackPageview',self.history.path.replace(/%d/,self.page)]);}});return jqxhr;};Scroller.prototype.maybeLoadMejs=function(){if(null===this.wpMediaelement){return;}
